...
Render a project structure or directory tree with collapsible folders and file icons.
...
Directories end with `/`, files don't. Nest items with indentation to create the tree structure.

> [!note]
> `FileTree` is an Astro component — wrap your markdown list with it. The import statement goes in the frontmatter section.
